...
void DMA::clear_interrupt_flags(Channel v)
{
    ...
    // if      (v == Channel::_1) IFCR.CGIF1 = true;
    // else if (v == Channel::_2) IFCR.CGIF2 = true;
    // else if (v == Channel::_3) IFCR.CGIF3 = true;
    // else if (v == Channel::_4) IFCR.CGIF4 = true;
    // else if (v == Channel::_5) IFCR.CGIF5 = true;
    registr(IFCR) = (1 << ((static_cast<uint8_t>(v) - 1)*4));
}
