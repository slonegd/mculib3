...
public:
   ...
   bool    is_ready_read (){return SR.RXNE;}
...
USART& USART::set(Baudrate baudrate, size_t clock)
{
   switch (baudrate) {
      case BR9600:
         BRR = clock/9600;  return *this;
      case BR14400:
         BRR = clock/14400; return *this;
      case BR19200:
         BRR = clock/19200; return *this;
      case BR28800:
         BRR = clock/28800; return *this;
      case BR38400:
         BRR = clock/38400; return *this;
      case BR57600:
         BRR = clock/57600; return *this;
      case BR76800:
         BRR = clock/76800; return *this;
      case BR115200:
         BRR = clock/115200;return *this;
   }
}


template <Periph usart, class Pin> constexpr PinMode USART::pin_mode()
{
...
template<Periph usart, class Pin> constexpr Periph USART::stream()
{
   if constexpr (usart == Periph::USART1) {
