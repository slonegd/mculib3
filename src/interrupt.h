...
Interrupt interrupt_DMA_channel1 {DMA1_Channel1_IRQn};
#if defined(STM32F0)
Interrupt interrupt_DMA_channel2 {DMA1_Channel2_3_IRQn};
Interrupt interrupt_DMA_channel3 {DMA1_Channel2_3_IRQn};
Interrupt interrupt_DMA_channel4 {DMA1_Channel4_5_IRQn};
Interrupt interrupt_DMA_channel5 {DMA1_Channel4_5_IRQn};
#elif defined(STM32F1)
Interrupt interrupt_DMA_channel2 {DMA1_Channel2_IRQn};
Interrupt interrupt_DMA_channel3 {DMA1_Channel3_IRQn};
Interrupt interrupt_DMA_channel4 {DMA1_Channel4_IRQn};
Interrupt interrupt_DMA_channel5 {DMA1_Channel5_IRQn};
Interrupt interrupt_DMA_channel6 {DMA1_Channel6_IRQn};
Interrupt interrupt_DMA_channel7 {DMA1_Channel7_IRQn};
#endif
