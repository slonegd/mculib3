...
Interrupt interrupt_EXTI9_5   {EXTI9_5_IRQn};
Interrupt interrupt_EXTI15_10 {EXTI15_10_IRQn};
#endif
...
constexpr auto& get_external_interrupt (int n)
{
    ...
    if (n >= 5 and n <= 9)   return interrupt_EXTI9_5;
    if (n >= 10 and n <= 15) return interrupt_EXTI15_10;
