...
#include "periph_dma.h"
   ...
   extern "C" void DMA1_Channel1_IRQHandler   () { interrupt_DMA_channel1.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_1);}
   extern "C" void DMA1_Channel2_IRQHandler   () { interrupt_DMA_channel2.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_2);}
   extern "C" void DMA1_Channel3_IRQHandler   () { interrupt_DMA_channel3.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_3);}
   extern "C" void DMA1_Channel4_IRQHandler   () { interrupt_DMA_channel4.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_4);}
   extern "C" void DMA1_Channel5_IRQHandler   () { interrupt_DMA_channel5.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_5);}
   extern "C" void DMA1_Channel6_IRQHandler   () { interrupt_DMA_channel6.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_6);}
   extern "C" void DMA1_Channel7_IRQHandler   () { interrupt_DMA_channel7.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(mcu::DMA::Channel::_7);}
   ...
   //extern "C" void DMA1_Stream0_IRQHandler() { interrupt_DMA_channel0.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_0); }
   extern "C" void DMA1_Stream1_IRQHandler() { interrupt_DMA_channel1.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_1); }
   extern "C" void DMA1_Stream2_IRQHandler() { interrupt_DMA_channel2.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_2); }
   extern "C" void DMA1_Stream3_IRQHandler() { interrupt_DMA_channel3.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_3); }
   extern "C" void DMA1_Stream4_IRQHandler() { interrupt_DMA_channel4.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_5); }
   extern "C" void DMA1_Stream5_IRQHandler() { interrupt_DMA_channel5.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_5); }
   extern "C" void DMA1_Stream6_IRQHandler() { interrupt_DMA_channel6.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_6); }
   extern "C" void DMA1_Stream7_IRQHandler() { interrupt_DMA_channel7.interrupt(); mcu::make_reference<mcu::Periph::DMA1>().clear_interrupt_flags(DMA::Channel::_7); }
   //extern "C" void DMA2_Stream0_IRQHandler() { interrupt_DMA_channel0.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_0); }
   extern "C" void DMA2_Stream1_IRQHandler() { interrupt_DMA_channel1.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_1); }
   extern "C" void DMA2_Stream2_IRQHandler() { interrupt_DMA_channel2.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_2); }
   extern "C" void DMA2_Stream3_IRQHandler() { interrupt_DMA_channel3.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_3); }
   extern "C" void DMA2_Stream4_IRQHandler() { interrupt_DMA_channel4.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_4); }
   extern "C" void DMA2_Stream5_IRQHandler() { interrupt_DMA_channel5.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_5); }
   extern "C" void DMA2_Stream6_IRQHandler() { interrupt_DMA_channel6.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_6); }
   extern "C" void DMA2_Stream7_IRQHandler() { interrupt_DMA_channel7.interrupt(); mcu::make_reference<mcu::Periph::DMA2>().clear_interrupt_flags(DMA::Channel::_7); }
   #endif
