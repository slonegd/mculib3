...
struct AHB1ENR {
   ...
   uint32_t              :2; // Bits 24:23 Reserved, must be kept at reset value.
...
struct APB1ENR {
   ...
   uint32_t          :2; // Bits 10:9 Reserved, must be kept at reset value.
   ...
   uint32_t          :1; // Bit 27 Reserved, must be kept at reset value.
...
struct APB2ENR {
   ...
   uint32_t          :13; // Bits 31:19 Reserved, must be kept at reset value.
}__attribute__((packed));
