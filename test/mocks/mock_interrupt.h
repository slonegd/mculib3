...
struct NVIC_Enable
{
    ...
    void operator() (IRQn_Type IRQn) {
        ...
        #if defined(STM32F0)
            case DMA1_Channel2_3_IRQn: process << "NVIC: включение прерывания DMA1_Channel2_3\n"; break;
            case DMA1_Channel4_5_IRQn: process << "NVIC: включение прерывания DMA1_Channel2_3\n"; break;
