...
BOOST_AUTO_TEST_CASE(is_transfer_complete_interrupt)
{
   ...
   CMSIS.HISR = 0;
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_0), true);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_1), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_2), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_3), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_4), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_5), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_6), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_7), false);
   ...
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_0), false);
   BOOST_CHECK_EQUAL (dma.is_transfer_complete_interrupt (mcu::DMA::Channel::_1), false);
