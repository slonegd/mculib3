...
// TODO после отладки привести к работающему тесту
...
BOOST_AUTO_TEST_CASE(start_receive)
{
    ...
    BOOST_CHECK_EQUAL (process.str(),
        ...
        "USART1: Pазрешение прерывания по простою\n"
    );
}
